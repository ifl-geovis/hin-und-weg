...
import { D3Sankey2, ID3SankeyItem} from "./D3Sankey2";
		...
		return (
			<div className="p-grid">
				...
				<div id="chartDiv" className="p-col-12">
                    <ContainerDimensions>
                        { ({ width, height }) => 
                            <D3Sankey2 width={width} height={(this.props.items.length <= 15)? 700 : 1000} data={this.props.items} theme={this.props.theme}/>
                        }
                    </ContainerDimensions>
