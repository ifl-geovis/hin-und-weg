...
export class D3Timeline2 extends React.Component<ITimelineD3Props>
{
	...
	private removePreviousChart(){
		  const chart = document.getElementById('chartD3Timeline2');
		  if (chart) {
	...
	public render(): JSX.Element
	{
		return (
			<div className="p-grid">
				<ContainerDimensions>
                        { ({ width, height }) => 
                            <svg id='chartD3Timeline2' width={width} height={width} ref={ref => (this.svgRef = ref)} />
                        }
                    </ContainerDimensions>
			</div>
		);
